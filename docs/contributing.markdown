...
We welcome your contributions to this project. Visit the project's [GitHub repo](https://github.com/The-AI-Alliance/red-teaming-work-group/){:target="repo"}, and the [open issues](https://github.com/The-AI-Alliance/red-teaming-work-group/issues){:target="repo"}, in particular, for areas where you might contribute.
...
For this documentation itself, the sources are in the GitHub repo's [`docs`](https://github.com/The-AI-Alliance/red-teaming-work-group/tree/main/docs){:target="repo-docs"} directory. 
...
The repo [README](https://github.com/The-AI-Alliance/red-teaming-work-group){:target="repo"} explains more details about contributing to this project.
