...
# Red Teaming Work Group

[GitHub Repo](https://github.com/The-AI-Alliance/red-teaming-work-group){:target="repo" .btn .btn-primary .fs-5 .mb-4 .mb-md-0 .mr-2 .no-glyph}
...
| **Last Update** | V0.0.1, 2025-05-05 |

Welcome to the **The AI Alliance**: **Red Teaming Work Group**.
...
* [Project GitHub Repo](https://github.com/The-AI-Alliance/red-teaming-work-group){:target="repo"}
