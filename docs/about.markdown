...
# About Red Teaming Work Group and The AI Alliance

**Red Teaming Work Group** is a project of the [Trust and Safety](https://thealliance.ai/focus-areas/trust-and-safety){:target="wg"} focus area in [The AI Alliance](https://thealliance.ai){:target="ai-alliance"}. This work group collaborates on datasets, workshops, whitepapers, and other resources for red teaming AI systems for better security and safety.
